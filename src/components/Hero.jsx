...
export default function Hero() {
  return (
    <div id="home" className="bg-[#245D51] text-white">
      <div className="max-w-7xl mx-auto px-4 relative">
        <div className="grid md:grid-cols-2 gap-10 h-[90vh]">
          <div className="flex flex-col">
            <h1 className="md:mt-20 xl:mt-20 mt-6 md:text-6xl text-3xl font-bold md:leading-[85px] leading-[45px] md:text-start text-center tracking-tight">
              There is <span className="">always</span> something new for us to
              learn
            </h1>
            ...
            <img
              className="absolute md:mt-40 md:ml-60 md:w-52 w-28 mt-[68px] ml-48"
              src={vectorline}
              alt="vector image"
              draggable="false"
            />
          ...
          <div className="flex justify-end ">
            ...
            <div className="absolute md:hidden block">
              <img
                ...
                alt="calender icon"
              />
              <img className="h-10 ml-72" src={play} alt="play icon" />
              <img
