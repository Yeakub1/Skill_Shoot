...
//         <div className="grid md:grid-cols-3 justify-evenly mt-10">
//           <div className="md:w-5/6 p-5 mt-9">
...
//             </div>
//           </div>
//           <div className="md:w-5/6 bg-[#245D51] rounded-3xl p-4 text-white shadow-2xl drop-shadow-2xl MOST-POPULAR mt-16 md:mt-0">
...
//             </div>
//           </div>
//           <div className="md:w-5/6 p-5 mt-12">
//             <div className="flex items-end">
